...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '天高万尺如登楼，莫忧莫惧莫回头🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Camellia', // 
  BIO: process.env.NEXT_PUBLIC_BIO || '明天会更好吗？🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://qiudehao.life', // 网站地址
  ...
  CONTACT_GITHUB: https://github.com/camiletf || '', // 你的github个人主页 例如 https://github.com/tangly1024
